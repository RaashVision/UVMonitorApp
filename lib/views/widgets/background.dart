...
const List<Color> violetGradients = [
   Color.fromRGBO(204,43,94,1),
   Color.fromRGBO(117,58,136,1),
 // Color(0xb66FFF),
];

const List<Color> bluepurpleGradients = [
   Color.fromRGBO(69,104,220,1),
   Color.fromRGBO(176,106,179,1),
 // Color(0xb66FFF),
];

const List<Color> aubergineGradient = [
   Color.fromRGBO(170,7,107,1),
   Color.fromRGBO(97,4,95,1),
 // Color(0xb66FFF),
];
